...
public class PaymentTokenResponse {
  @SerializedName("data")
  private PaymentTokenResponseData data = null;

  public PaymentTokenResponse data(PaymentTokenResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public PaymentTokenResponseData getData() {
    return data;
  }

  public void setData(PaymentTokenResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, paymentTokenResponse.data);
  }
